...
👉 **https://qubee-nlp.readthedocs.io**
...
Qubee NLP also provides CLI utilities for:
- Tokenization
- Stemming
- Corpus processing
- Benchmarking
...
Welcome to **Qubee NLP**, a comprehensive Natural Language Processing (NLP) library for **Afaan Oromoo (Oromo language)** using the **Qubee script**.
